...
import { ChangePasswordDto, CompleteUserProfileDto, CreateUserDto, LoginUserDto, PasswordCheckDto, ResetPasswordDto } from '@dtos/users.dto';
...
export class AuthRoute implements Routes {
    ...
    private initializeRoutes() {
        ...
        this.router.post(
            ...
            /*
                #swagger.path = '/auth/check-password'
                #swagger.tags = ['Auth']
                #swagger.parameters['Authorization'] = {
                    in: 'cookie',
                ...
                #swagger.responses[200] = {
                    ...
                    schema: {
                        ...
                        messageEn: 'Password is correct',
                        messageAr: "كلمة المرور صحيحة"
                    }
                }
            */
            AuthMiddleware,
            ValidationMiddleware(PasswordCheckDto),
            errorWrapper(this.auth.checkPassword)
        );

        this.router.patch(
            `${this.path}/change-password`,
            /*
                #swagger.path = '/auth/change-password'
                #swagger.tags = ['Auth']
                #swagger.parameters['Authorization'] = {
                    in: 'cookie',
                    description: 'Bearer token for authentication',
            ...
            */
            ...
            errorWrapper(this.auth.changePassword)
        );
    }
}
